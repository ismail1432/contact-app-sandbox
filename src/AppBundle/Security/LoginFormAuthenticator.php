...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    function __construct(FormFactoryInterface $formFactory, EntityManagerInterface $entityManager, RouterInterface $router)
    {
    ...
    public function getUser($credentials, \Symfony\Component\Security\Core\User\UserProviderInterface $userProvider)
    {
        ...
        return $this->entityManager->getRepository('AuthenticatorSandboxBundle:User')->findOneBy(['username' => 'eniams']);
    }
